...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormData({ name: '', email: '', service: 'Company Profile', message: '' });
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Punya project dalam pikiran? Mari diskusikan dan wujudkan bersama!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@chizuniverse.com" className="text-gray-600 hover:text-purple-600 transition-colors">
                      hello@chizuniverse.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-purple-600 transition-colors">
                      +62 812-3456-7890
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-white shadow-lg">
              <h3 className="text-2xl font-bold mb-4">Atau Hubungi Langsung</h3>
              <p className="mb-6">
                Dapatkan konsultasi gratis dan respons cepat melalui WhatsApp!
              </p>
              <a
                href="https://wa.me/6281234567890?text=Halo%20CHIZUNIVERSE,%20saya%20tertarik%20untuk%20membuat%20website"
                target="_blank"
